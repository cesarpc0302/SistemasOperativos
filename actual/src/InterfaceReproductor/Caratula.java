...
import reproductor.llamadaServer;
...
public class Caratula extends javax.swing.JFrame {
    ...
    llamadaServer server;

    public Caratula() throws IOException {
        initComponents();
        setLocationRelativeTo(null);
        this.cancionRepro = new CargaDelServer();
        server = new llamadaServer();
    }
    ...
    private void jList1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jList1MouseClicked
        ...
        if (evt.getClickCount() == 2) {
            try {
                try {
                    // TODO add your handling code here:
                    server.pedirLista(jList1.getSelectedValue());
                    //cancionRepro.cargaCancionesDesdeLista(); aca es donde debería llamar a la lista de nombres de las canciones
                    } catch (IOException ex) {
                        Logger.getLogger(Caratula.class.getName()).log(Level.SEVERE, null, ex);
                    }
